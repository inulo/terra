...
<script>let
  ...
  const
	MAX_ANG = 23.4,
	MONTHS = ['Dezembro', 'Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro' ];
...
.orbit-container .sun {
  ...
  left: calc(50% - 40px);
  border-radius: 100%;
  background-color: hsla(60, 100%, 81%, 1);;
  padding: 40px;
  pointer-events: none;
}
